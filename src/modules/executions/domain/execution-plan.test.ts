...
describe("buildExecutionPlan", () => {
  it("numera y hashea el contenido ejecutable de forma estable", () => {
    const first = buildExecutionPlan({ ...base, operations: [{ type: "CREATE", requestSnapshot: { b: 2, a: 1 } }, { type: "VERIFY", targetRemotePlanId: "remote-1" }] });
    const second = buildExecutionPlan({ ...base, operations: [{ type: "CREATE", requestSnapshot: { a: 1, b: 2 } }, { type: "VERIFY", targetRemotePlanId: "remote-1" }] });
